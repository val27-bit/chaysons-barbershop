    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
        ...
        <button
          ...
          className="md:hidden relative z-50 flex h-10 w-10 items-center justify-center rounded-lg hover:bg-accent transition-colors"
      ...
      >
        <div className="flex flex-col gap-2 pt-24 px-6">
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                onClick={() => setMenuOpen(false)}
                className={`
                  px-4 py-3 rounded-xl text-sm font-semibold uppercase tracking-[0.1em]
                  transition-all duration-200
                  ${isActive
                    ? "bg-accent text-foreground"
                    : "text-text-secondary hover:bg-accent/60 hover:text-foreground"
                  }
                `}
              >
                {link.label}
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-full bg-foreground px-6 py-3 text-xs font-bold uppercase tracking-widest text-white transition-all hover:bg-slate-800"
          >
